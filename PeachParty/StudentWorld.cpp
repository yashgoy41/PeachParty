            ...
            for(int j = 0; j < BOARD_HEIGHT; j++){
                ...
                switch (ge) {
                    ...
                    case Board::left_dir_square:
                        actorList.push_back(new DirectionSquare(IID_DIR_SQUARE, i*16,j*16, this));
                        break;
                    ...
                    case Board::event_square:
                        actorList.push_back(new EventSquare(IID_EVENT_SQUARE, i*16,j*16, this));
                        break;
                    case Board::bank_square:
                        actorList.push_back(new BankSquare(IID_BANK_SQUARE, i*16,j*16, this));
                        break;
                    case Board::star_square:
                        actorList.push_back(new StarSquare(IID_STAR_SQUARE, i*16,j*16, this));
                        break;
                }
            }
        }
